...
const applicationSchema = new mongoose.Schema(
  {
    ...
    feedback_1: {
      _id: false,
      Excited: {type: Number,get: (v) => Math.round(v * 100) / 100, default: 0.0},
      Engaged: {type: Number,get: (v) => Math.round(v * 100) / 100, default: 0.0},
      Smiled: {type: Number,get: (v) => Math.round(v * 100) / 100, default: 0.0},
      RecommendHiring: {type: Number,get: (v) => Math.round(v * 100) / 100, default: 0.0},
      NoFillers: {type: Number,get: (v) => Math.round(v * 100) / 100, default: 0.0},
      StructuredAnswers: {type: Number,get: (v) => Math.round(v * 100) / 100, default: 0.0},
      Friendly: {type: Number,get: (v) => Math.round(v * 100) / 100, default: 0.0},
      Focused: {type: Number,get: (v) => Math.round(v * 100) / 100, default: 0.0},
      NotAwkward: {type: Number,get: (v) => Math.round(v * 100) / 100, default: 0.0},
      Paused: {type: Number,get: (v) => Math.round(v * 100) / 100, default: 0.0},
      EyeContact: {type: Number,get: (v) => Math.round(v * 100) / 100, default: 0.0},
      Authentic: {type: Number,get: (v) => Math.round(v * 100) / 100, default: 0.0},
      Calm: {type: Number,get: (v) => Math.round(v * 100) / 100, default: 0.0},
      SpeakingRate: {type: Number,get: (v) => Math.round(v * 100) / 100, default: 0.0},
      NotStressed: {type: Number,get: (v) => Math.round(v * 100) / 100, default: 0.0},
      total_score: {type: Number, get: (v) => Math.round(v * 100) / 100, default: 0.0},
    },
    feedback_2: {
      _id: false,
      text: {type: String}
